...
こんにちは。これは通知テストです。
	*/
	...
	export type RootResponse = Donation | SupportDonation | TwitchFollow | TwitchSubscribe | TwitchHosting | TwitchCheer | YouTubeSuperChat | YouTubeSubscribe | YouTubeMemberShip
